      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden p-5">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          {terrace.terraceType?.length ? (
            <InfoItem
              label={t.type}
              value={terrace.terraceType.map((tt) => typeLabels[tt]).join(", ")}
            />
          ) : null}
          {terrace.cuisineType && (
            <InfoItem
          ...
          {terrace.capacity ? (
            <InfoItem
              label={t.capacity}
              value={t.seatsDetail(terrace.capacity)}
            />
          ) : null}
        ...
        <div className="pb-4 border-b border-border flex items-center justify-between mb-6">
          ...
          >
            ...
            >
              <path
                d="M15.232 5.232l3.536 3.536M9 13l6.586-6.586a2 2 0 012.828 2.828L11.828 15.828a2 2 0 01-1.414.586H8v-2a2 2 0 01.586-1.414z"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
            </svg>
        ...
        <ReviewSection
          ...
          googleRating={terrace.googleRating}
          googleReviewCount={terrace.googleReviewCount}
        />
      </div>
    </div>
  );
