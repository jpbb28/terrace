...
export const terraces: Terrace[] = [
  ...
  {
    id: "182",
    name: "Resto Pub Bord'Eaux",
    address: "53A Rue Sainte-Anne",
    lat: 45.4080,
    lng: -73.9565,
    neighborhood: "West Island",
    cuisineType: "Gastropub / Canadian",
    terraceType: "backyard",
    covered: false,
    dogFriendly: false,
    heated: false,
    website: "https://www.restopubbordeaux.com",
    photos: [],
    description:
      "Ranked #1 of 21 restaurants in Sainte-Anne-de-Bellevue on TripAdvisor, this renovated ancestral home features a lakeside terrace with glowing lanterns and views over Lac Saint-Louis. Homestyle bistro menu: mussels, calamari, hand-crafted burgers, and fresh fish. Sources: TripAdvisor, RestoMontreal.",
  },
  {
    id: "183",
