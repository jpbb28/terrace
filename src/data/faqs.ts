// FAQ content lives in a plain (non-"use client") module so both the client
// FaqContent component and the server FAQ pages (for FAQPage JSON-LD) can import
// the actual arrays. Importing data out of a "use client" module into a server
// component yields client-reference proxies, not the real values.
...
export const faqsEn: Faq[] = [
  {
    ...
    link: {
      href: "/blog/when-do-montreal-terrasses-open",
      label: "When do terraces open? →",
    },
  },
  {
  ...
  },
  {
    ...
    link: {
      href: "/blog/dog-friendly-terrasses-montreal",
      label: "Read the dog-friendly guide →",
    },
  },
  {
...
export const faqsFr: Faq[] = [
  {
    ...
    link: {
      href: "/blog/when-do-montreal-terrasses-open",
      label: "Quand ouvrent les terrasses? →",
    },
  },
  {
  ...
  },
  {
    ...
    link: {
      href: "/blog/dog-friendly-terrasses-montreal",
      label: "Lire le guide dog-friendly →",
    },
  },
  {
