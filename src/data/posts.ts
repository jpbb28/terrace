...
export const posts: Post[] = [
  {
    ...
    content: [
      ...
      { t: "p", text: "And yet even with the staggered openings, there's a moment when it tips. Café owners drag out tables at 7am. By noon, every sidewalk on Saint-Laurent has people sitting on it, still wearing jackets, ordering wine they don't strictly need at that hour. Nobody cares. The season has started." },
