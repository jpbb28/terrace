...
export const posts: Post[] = [
  {
    ...
    content: [
      ...
      { t: "p", text: "And yet even with the staggered openings, there's a moment when it tips. Café owners drag out tables at 7am. By noon, every sidewalk on Saint-Laurent has people sitting on it, still wearing jackets, ordering wine they don't strictly need at that hour. The season has started." },
    ...
    contentFr: [
      ...
      { t: "p", text: "Mais même avec des ouvertures éparpillées, il y a un moment où on le sent dans l'air. Les proprios traînent leurs tables à 7h du matin. À midi, les trottoirs de Saint-Laurent sont pleins de monde encore en manteau, qui commandent du vin dont on avait pas vraiment besoin à cette heure-là. La saison a commencé." },
