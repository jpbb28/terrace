...
export const posts: Post[] = [
  {
    ...
    content: [
      ...
      { t: "p", text: "But there's a day when it tips. Café owners drag out tables at 7am. By noon, every sidewalk on Saint-Laurent has people sitting on it, still wearing jackets, ordering wine at noon. Nobody cares. The season has started." },
    ...
    contentFr: [
      ...
      { t: "p", text: "Mais il y a un jour où ça bascule. Les proprios traînent leurs tables à 7h du matin. À midi, les trottoirs de Saint-Laurent sont pleins de monde encore en manteau, qui commandent du vin à midi. On s'en fout. La saison a commencé." },
