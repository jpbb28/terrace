...
export const posts: Post[] = [
  {
    ...
    content: [
      ...
      { t: "p", text: "The thing about Montréal terrasse season that people from warmer places don't understand: it means something here. You've earned it. Every February morning when you scraped ice off your windshield at -25, every March when you thought spring was coming and got another foot of snow — that's the bill, and the terrasse is how you collect." },
      { t: "p", text: "The season runs longer than you'd think. Heated covered places push well into October. Some technically never close. But the real season — the season of lingering, of staying for another drink because why would you go inside — that's June through September." },
      { t: "divider" },
  ...
  },
  {
    ...
    date: "June 1, 2025",
    content: [
      { t: "p", text: "Montréal has always been a dog city. Walk any street in the Plateau on a Saturday morning and count. The density is remarkable. People here have dogs the way other cities have cars — as a fundamental part of how they move through the world." },
