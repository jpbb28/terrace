...
export const posts: Post[] = [
  {
    ...
    description: "Most terrasses start opening in May, some earlier if the weather plays along. Here's what the season actually looks like, month by month, and why September deserves more attention than it gets.",
  ...
  },
  {
    ...
    content: [
      ...
      { t: "labeled", name: "Mile End", text: "A different energy than the Plateau. The terrasse scene here is younger and less concerned with what things look like. Natural wine on a wooden bench is more common than tablecloths and a printed menu. Bernard and Saint-Viateur. If you want the density of the Plateau but with more room to breathe, this is closer to what you're after." },
      { t: "labeled", name: "Old Montréal", text: "Some of the best terrasse views in the city. Hotel rooftops, canal-side spots, cobblestone terraces with the architecture right there. The quieter streets away from Place Jacques-Cartier have the best options. The river is close. Worth it if you pick carefully." },
      ...
      { t: "labeled", name: "Downtown", text: "More spread out than the other neighbourhoods, which changes how it feels. The best spots are hotel rooftops with views of the mountain, and a handful of solid terrasses around Peel and the quieter streets near McGill. Crescent Street exists and is what it is. Worth it if you know where you're going." },
