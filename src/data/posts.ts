...
export const posts: Post[] = [
  {
    ...
    contentFr: [
      ...
      { t: "p", text: "Mais il y a un jour où ça bascule. Les proprios traînent leurs tables à 7h du matin. Et bientôt, les trottoirs de Saint-Laurent sont pleins de monde encore en manteau, qui commandent du vin à midi. La saison a commencé." },
