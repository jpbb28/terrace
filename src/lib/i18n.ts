...
export const translations = {
  en: {
    ...
    correctSubtitle: (name: string) =>
      `Update the details for ${name}. Edit any fields that are wrong or missing and submit.`,
    ...
    descriptionPlaceholder:
      "What makes this terrace special? Views, vibe, notable features...",
    ...
    photoHint:
      "JPG, PNG, WEBP \u2014 up to 5 files \u2014 main photo should be landscape",
    photoMainBadge: "Main",
    ...
    submitMsg:
      "We'll review your terrace and add it to the map soon. We may reach out to you if we need more details.",
    ...
    openPageSubtitle:
      "See which Montreal terraces are open this season. Know a spot that's ready for summer?",
    openPageSubtitleCta: "Let the community know.",
  ...
  fr: {
    ...
    submitSubtitle:
      "Vous connaissez une belle terrasse absente de la carte\u00A0? Propri\u00E9taire, g\u00E9rant ou client fid\u00E8le \u2014 aidez-nous \u00E0 enrichir la liste.",
    correctSubtitle: (name: string) =>
      `Mettez \u00E0 jour les informations pour ${name}. Modifiez les champs incorrects ou manquants et soumettez.`,
    ...
    descriptionLabel: "Description",
    descriptionPlaceholder:
      "Qu\u2019est-ce qui rend cette terrasse sp\u00E9ciale\u00A0? Vue, ambiance, caract\u00E9ristiques notables...",
    ...
    photoHint:
      "JPG, PNG, WEBP \u2014 jusqu\u2019\u00E0 5 fichiers \u2014 la photo principale devrait \u00EAtre en format paysage",
    ...
    correctionMsg:
      "Nous examinerons vos suggestions et mettrons \u00E0 jour la fiche si tout est correct.",
    submitMsg:
      "Nous examinerons votre terrasse et l\u2019ajouterons \u00E0 la carte bient\u00F4t. Nous pourrions vous contacter si nous avons besoin de plus d\u2019informations.",
    ...
    sortRating: "Populaires",
    sortDistance: "Distance",
    clearAll: "Tout effacer",
    neighborhoods: "quartiers",
    types: "types",
    noPhotoYet: "Pas encore de photo",
    submitPhoto: "Soumettre une",
    openLabel: "Ouvert",
    closedLabel: "Fermé",
    ...
    openPageSubtitle:
      "Découvrez quelles terrasses sont ouvertes cette saison. Un endroit est déjà ouvert ou prêt pour l'été\u00a0?",
    openPageSubtitleCta: "Faites-le savoir à la communauté.",
